...
export async function POST(req: Request) {
     ...
     * Fetch user details from event data
     ...
     * Fetch updated user details from event data
     * Update user in app database with new details
    ...
    // DELETE
    /**
     * Handle Clerk webhook for user delete event
     * Delete user with matching id from app database
